  ...
  return (
	...
	<div>
	  <div className="mt-10 flex ml-20 space-x-2 ">
		...
		<a className=" text-4xl mt-2">หน้าแรก/คอนโด</a>
	  </div>
	...
	<a href="#" className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
	  <div className="shadow p-4 rounded-lg bg-white">
		...
		<div className="absolute flex justify-center bottom-0 mb-3">
			<div className="flex  px-4 py-1 space-x-5 ">
		  ...
		  <div className="flex justify-end">
			<p className="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl">
			  <span clasNames="text-sm uppercase">
				$
			  </span>
